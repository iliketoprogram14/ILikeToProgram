...
After that, I changed up the font from <a href="http://en.wikipedia.org/wiki/Georgia_(typeface)" target="_blank">Georgia Sans-Serif</a> to Segoe UI, which you should be able to see now if you're on a relatively modern computer. Doing that and adding some spacing between lines made the page a lot cleaner and more readable, and the site doesn't look *that* bad anymore. I still need to fix the color scheme though :P

I also added four projects I've done over the past year to the <a href="projects.php"> page:
<ul><li><a href="projects.php?project=7">A Kinect-controlled Arduino car</a> (my favorite)</li><li><a href="projects.php?project=8">A distributed task list</a></li><li><a href="projects.php?project=11">Morse code instant messaging</a> (Yes, it's just as crazy as it sounds</li><li><a href="projects.php?project=12">Parallel image segmentation</a></li></ul>
